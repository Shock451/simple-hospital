...
import { fetchDoctorList, postRequest } from "../helpers/api";

function MedsRefillRequest(props) {
    ...
    async function postSubmit(medsrefill) {
        setIsLoading(true);
        const { status, data } = await postRequest(medsrefill)
        if (status === 200) {
            props.history.push({
                pathname: "/meds-refill",
                state: {
                    success: "Medicine requested successfully"
                }
            });
        } else {
            setIsLoading(false);
                ...
                <div className="content container-fluid">
                    <div className="page-header">
                        <div className="row align-items-center">
                            <div className="col">
                                <h3 className="page-title">Request Medicine Refill</h3>
                                <ul className="breadcrumb">
                                    {/* <li className="breadcrumb-item"><Link to={'/readings'}>Schedule Appointment</Link></li> */}
                                    <li className="breadcrumb-item active">Request Medicine Refill</li>
                                </ul>
                            </div>
                            ...
                            <div className="card">
                                <form onSubmit={handleSubmit(postSubmit)}>
                                    ...
                                    <div className="card-header">
                                        <h4 className="card-title mb-0">Request Info</h4>
                                    </div>
                                    ...
                                    <div className="card-body">
                                        <div className="form-group row">
                                            <div className="col-md-12 mt-3">
                                                <label>Details of request<em>*</em></label>
                                            ...
                                            <div className="col-md-12 mt-3">
                                                ...
                                                })} className="form-control" name="date" type="datetime-local" defaultValue=""/>
...
export default MedsRefillRequest;