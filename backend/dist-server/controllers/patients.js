...

{
  ...
  getReadingByPatientId: function () {var _getReadingByPatientId = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(req, res) {var patient_id, id, _yield$getReadingByPa, _yield$getReadingByPa2, record;return regeneratorRuntime.wrap(function _callee5$(_context5) {while (1) {switch (_context5.prev = _context5.next) {case 0:
              patient_id = req._id;

              id = req.params.id;_context5.next = 4;return (

                (0, _patient.getReadingByPatient)(id, patient_id));case 4:_yield$getReadingByPa = _context5.sent;_yield$getReadingByPa2 = _slicedToArray(_yield$getReadingByPa, 1);record = _yield$getReadingByPa2[0];if (

              record) {_context5.next = 10;break;}
              res.status(404).json({
                err: "Not found" });return _context5.abrupt("return");case 10:




              res.status(200).json(record);case 11:case "end":return _context5.stop();}}}, _callee5);}));function getReadingByPatientId(_x9, _x10) {return _getReadingByPatientId.apply(this, arguments);}return getReadingByPatientId;}(),


  postReadingsByPatientId: function () {var _postReadingsByPatientId = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6(req, res) {var user_id, _req$body, blood_pressure, blood_sugar, heart_rate, temperature, added;return regeneratorRuntime.wrap(function _callee6$(_context6) {while (1) {switch (_context6.prev = _context6.next) {case 0:
              user_id = req._id;_req$body =
              req.body, blood_pressure = _req$body.blood_pressure, blood_sugar = _req$body.blood_sugar, heart_rate = _req$body.heart_rate, temperature = _req$body.temperature;_context6.next = 4;return (

                (0, _patient.addReadingsById)({
                  patient_id: user_id,
                  blood_pressure: blood_pressure,
                  blood_sugar: blood_sugar,
                  heart_rate: heart_rate,
                  temperature: temperature }));case 4:added = _context6.sent;if (


              added) {_context6.next = 8;break;}
              res.status(500).json({
                err: "An error occured" });return _context6.abrupt("return");case 8:




              res.status(200).json({
                msg: "Record added successfully" });case 9:case "end":return _context6.stop();}}}, _callee6);}));function postReadingsByPatientId(_x11, _x12) {return _postReadingsByPatientId.apply(this, arguments);}return postReadingsByPatientId;}(),



  updateReadingByPatientId: function () {var _updateReadingByPatientId = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7(req, res) {var user_id, id, _req$body2, blood_pressure, blood_sugar, heart_rate, temperature, updated;return regeneratorRuntime.wrap(function _callee7$(_context7) {while (1) {switch (_context7.prev = _context7.next) {case 0:
              user_id = req._id;
              id = req.params.id;_req$body2 =
              req.body, blood_pressure = _req$body2.blood_pressure, blood_sugar = _req$body2.blood_sugar, heart_rate = _req$body2.heart_rate, temperature = _req$body2.temperature;_context7.next = 5;return (

                (0, _patient.updateReadingsById)(id, user_id, {
                  blood_pressure: blood_pressure,
                  blood_sugar: blood_sugar,
                  heart_rate: heart_rate,
                  temperature: temperature }));case 5:updated = _context7.sent;if (


              updated) {_context7.next = 9;break;}
              res.status(500).json({
                err: "An error occured" });return _context7.abrupt("return");case 9:




              res.status(200).json({
                msg: "Record updated successfully" });case 10:case "end":return _context7.stop();}}}, _callee7);}));function updateReadingByPatientId(_x13, _x14) {return _updateReadingByPatientId.apply(this, arguments);}return updateReadingByPatientId;}(),



  deleteReadingsByPatientId: function () {var _deleteReadingsByPatientId = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee8(req, res) {var user_id, reading_id, deleted;return regeneratorRuntime.wrap(function _callee8$(_context8) {while (1) {switch (_context8.prev = _context8.next) {case 0:
              user_id = req._id;
              reading_id = req.params.id;_context8.next = 4;return (

                (0, _patient.deleteReadingsById)(user_id, reading_id));case 4:deleted = _context8.sent;if (

              deleted) {_context8.next = 8;break;}
              res.status(500).json({
                err: "An error occured" });return _context8.abrupt("return");case 8:




              res.status(200).json({
                msg: "Record deleted successfully" });case 9:case "end":return _context8.stop();}}}, _callee8);}));function deleteReadingsByPatientId(_x15, _x16) {return _deleteReadingsByPatientId.apply(this, arguments);}return deleteReadingsByPatientId;}() };exports.default = _default;